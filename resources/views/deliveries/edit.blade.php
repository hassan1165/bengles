...
@section('content')
    @include('deliveries.partials.header', ['title' => __('Edit Delivery')])
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('deliveries.update', $delivery) }}" autocomplete="off">
                            @csrf
                            @method('put')
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('date') ? ' has-danger' : '' }}">
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input name="date" class="form-control datepicker" placeholder="Select date" type="text" value="{{ old('date', date("m/d/Y", strtotime($delivery->date)) ) }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('claim') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="claim" id="input-claim" class="form-control form-control-alternative{{ $errors->has('claim') ? ' is-invalid' : '' }}" placeholder="{{ __('Claim') }}" value="{{ old('claim', $delivery->claim) }}" required autofocus>
