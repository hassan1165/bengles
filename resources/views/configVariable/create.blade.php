...
@section('content')
    @include('configVariable.partials.header', ['title' => __('Add Config Variable')])
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('configVariable.store') }}" autocomplete="off">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('default_values') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="default_values" id="input-default_values" class="form-control form-control-alternative{{ $errors->has('default_values') ? ' is-invalid' : '' }}" placeholder="{{ __('Added By') }}" value="{{ old('default_values') }}" autofocus>
                                ...
                                <div class="form-group{{ $errors->has('key') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="key" id="input-key" class="form-control form-control-alternative{{ $errors->has('key') ? ' is-invalid' : '' }}" placeholder="{{ __('Key') }}" value="{{ old('key') }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('value') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="value" id="input-value" class="form-control form-control-alternative{{ $errors->has('value') ? ' is-invalid' : '' }}" placeholder="{{ __('Value') }}" value="{{ old('value') }}" autofocus>
